...
### Script Folder Strucutre
  ...
  * `lib/foundation/bower_components/`: This is the source folder where all Foundation components are located. `foundation update` will check and update scripts in this folder.
  ...
  * `js/vendor`: Vendor scripts are copied from `lib/foundation/bower_components/` to this directory. We use this path for enqueing the vendor scripts in WordPress.
