...
class Options_Framework {
	...
	function set_theme_option() {
        ...
        if ( function_exists( 'wwm_2015_optionsframework_option_name' ) ) {
			wwm_2015_optionsframework_option_name();
        }
        elseif ( has_action( 'wwm_2015_optionsframework_option_name' ) ) {
			do_action( 'wwm_2015_optionsframework_option_name' );
        }
	...
	/**
	 * Wrapper for wwm_2015_optionsframework_options()
	 *
	 ...
	 */
	static function &_wwm_2015_optionsframework_options() {
		static $options = null;
		...
		if ( !$options ) {
	        ...
	        if ( $optionsfile = locate_template( $location ) ) {
	            ...
	            } else if ( function_exists( 'wwm_2015_optionsframework_options' ) ) {
					$options = wwm_2015_optionsframework_options();
				}
	        }
