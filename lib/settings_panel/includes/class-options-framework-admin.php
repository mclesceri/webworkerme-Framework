...
class Options_Framework_Admin {
    ...
    public function init() {
    	...
    	$options = & Options_Framework::_wwm_2015_optionsframework_options();
	...
	static function menu_settings() {
		...
		$menu = array(
			...
			'menu_title' => __('WWM Settings', 'options-framework'),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'wwm_2015_options-framework',
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', get_template_directory_uri() . '/lib/settings_panel/js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );

		//Enqueue misc. styles/scripts
		$template_dir = get_template_directory_uri();
		//Load the Theme Panel Styles
		wp_enqueue_style('Theme-Panel', $template_dir . '/lib/settings_panel/css/theme-panel.css');
		
		//Load the Main Custom jQuery font, for .
		wp_enqueue_script('Conditionals', $template_dir . '/lib/settings_panel/js/main.js', array(), '1.0.0', false);

		//Load a few fonts.
		wp_enqueue_style('Raleway', 'http://fonts.googleapis.com/css?family=Raleway:700,400,300');
		wp_enqueue_style('Questrial', 'http://fonts.googleapis.com/css?family=Questrial' );
     ...
     */
	 function options_page() { ?>
		...
		<div id="optionsframework-wrap" class="wrap im_still_loading">
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit" class="row">
					<input type="submit" class="primary_button" name="update" value="<?php esc_attr_e( 'Save Options', 'options-framework' ); ?>" />
					<input type="submit" class="reset-button secondary_button" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'options-framework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'options-framework' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function get_default_values() {
		$output = array();
		$config = & Options_Framework::_wwm_2015_optionsframework_options();
